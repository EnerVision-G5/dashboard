/**
 * Table des routes du dashboard (EV-48, EV-50).
 *
...
export function AppRoutes() {
  return (
    <Routes>
      ...
      {/* Les écrans authentifiés partagent une route parente : elle porte la
          garde de session et la navigation principale, si bien qu'un écran
